...
local black = hsl("#0A0A0F")
local white = hsl("#F5EFED")
local green = hsl("#00A896")
local red = hsl("#F72C25")

local blue2 = hsl("#8F87F1")
local purple = hsl("#C68EFD")
local pink = hsl("#C68EFD")
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    -- Cursor({ bg = VaporLush.Background }), -- Character under the cursor
    ...
    Normal({ bg = grey[900], fg = grey[50] }), -- Normal text
    ...
    Winseparator({ fg = grey[800] }), -- Separator between window splits. Inherts from |hl-VertSplit| by default, which it will replace eventually.
