...
local norm_fg = hsl("#D4D4D4")
local norm_bg = hsl("#1E1E1E")

local dark_red = hsl("#D16969")
local orange = hsl("#f9ae28")
local brown = hsl("#CE9178")
local yellow = hsl("#DCDCAA")
local yellow_orange = hsl("#D7BA7D")
local green = hsl("#6A9955")
local blue_green = hsl("#4EC9B0")
local light_green = hsl("#B5CEA8")
local blue = hsl("#4fc1ff")
local light_blue = hsl("#9CDCFE")
local dark_blue = hsl("#569CD6")
local cornflower_blue = hsl("#6796E6")
local dark_pink = hsl("#C586C0")
local bright_pink = hsl("#f92672")
local purple = hsl("#ae81ff")

local white = hsl("#ffffff")
local gray = hsl("#51504f")
local gray2 = hsl("#858585") -- LineNr (editorLineNumber.foreground)
...
local hint_gray = hsl("#B0B0B0")
local ok_green = hsl("#89d185") -- color for success, so I use notebookStatusSuccessIcon.foreground

local selected_item_bg = hsl("#04395e")
local matched_chars = hsl("#2aaaff")
local folded_blue = hsl("#202d39") -- editor.foldBackground
local float_border_fg = hsl("#454545")
local indent_guide_fg = hsl("#404040")
local indent_guide_scope_fg = hsl("#707070")
local label_fg = hsl("#c8c8c8")
...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    SelectionHighlightBackground({ bg = hsl("#333a40") }),
    LightBulb({ fg = hsl("#ffcc00") }),
    CodeLens({ fg = hsl("#999999") }),
    GutterGitAdded({ fg = hsl("#487e02") }),
    GutterGitDeleted({ fg = hsl("#f14c4c") }),
    GutterGitModified({ fg = hsl("#1b81a8") }),
    Breadcrumb({ fg = hsl("#a9a9a9"), bg = norm_bg }),
